...
def add_new_shelf_ui():
    shelf_number = input('Введите номер полки - ')
    return add_new_shelf(shelf_number)
...
def delete_doc_ui():
    user_doc_number = input('Введите номер документа - ')
    return delete_doc(user_doc_number)
